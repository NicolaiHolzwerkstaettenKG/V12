...
class Ecofi(models.Model):
    ...
    def ecofi_posted_moves(self, journal_ids):
        ...
        for move in move_ids:
            if move.amount_total_signed == 0:
                # Do not export zero value invoices
                continue
            ...
            for line in move.line_ids:
                ...
                if journal.type in ['bank', 'cash']:
                    if line.account_id == journal.suspense_account_id:
                        ignore_move = True
                        break
    ...
    def ecofi_buchungen(self, journal_ids, date_from, date_to):  # noqa: C901
        ...
        vorlauf_id = self.env['ecofi'].create({
            ...
            'date_from': date_from,
            'date_to': date_to,
            'journale': ','.join(journal_ids.mapped('name')),
        })
        ...
        account_moves = vorlauf_id.ecofi_posted_moves(journal_ids)
