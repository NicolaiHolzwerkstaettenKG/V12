...
#             </xsd:documentation>
#             <xsd:documentation>
#               xsd:attribute content: additional fields for unavailable information content;
#               the attribute Content describes the missing attribute. It contains the value.
#             </xsd:documentation>
#         </xsd:annotation>
